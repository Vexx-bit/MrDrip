...
<nav class="navbar" id="sticky-navbar">
    ...
    <div class="container mt-5">
        <a href="kids.php" class="btn btn-secondary mb-3">Back to Subcategories</a>
        ...
        if (isset($_GET['delete_product'])) {
            ...
            if ($stmt) {
                mysqli_stmt_bind_param($stmt, "i", $delete_product_id);
                mysqli_stmt_execute($stmt);
        
                if (mysqli_stmt_affected_rows($stmt) > 0) {
                    echo "<script>window.open('view_productskids.php?subcategory=" . urlencode($_GET['subcategory']) . "', '_self');</script>";
                    exit();
                }
        ...
        if (isset($_GET['subcategory'])) {
            ...
            $query = "SELECT * FROM products WHERE product_category = 'kids' AND product_subcategory = '$subcategory'";
