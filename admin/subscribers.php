...
$sqlSubscribers = "SELECT * FROM newsletters";
$resultSubscribers = mysqli_query($conn, $sqlSubscribers);
$subscribers = mysqli_fetch_all($resultSubscribers, MYSQLI_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <nav class="navbar" id="sticky-navbar">
        <div class="container-fluid">
            ...
            <span class="navbar-brand">Subscribers </span>
    ...
    <div class="container mt-4">
        <?php foreach ($subscribers as $index => $subscriber) { ?>
            <div class="subscriber-card">
                <div class="subscriber-column"><?php echo $subscriber["email"]; ?></div>
                <div class="subscriber-column">
                    <a class="btn-primary text-decoration-none" href="mailto:<?php echo $subscriber["email"]; ?>">Send newsletter</a>
                </div>
            </div>
        <?php } ?>
    </div>
