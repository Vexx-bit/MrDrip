...
<body>
    <nav class="navbar" id="sticky-navbar">
        <div class="container-fluid">
            ...
            <span class="navbar-brand">Kids </span>
...
if(isset($_POST['addSubcategory'])) {
    ...
    $insertSubcategoryQuery = "INSERT INTO kids (subcategory) VALUES ('$subcategoryName')";
    if(mysqli_query($conn, $insertSubcategoryQuery)) {
        // Success: Redirect to kids.php (or refresh the page)
        echo"<script>window.open('kids.php','_self')</script>";
        exit();
    } else {
...
if(isset($_GET['deleteCategory'])) {
    ...
    // Delete the category from the kids table
    $deleteCategoryQuery = "DELETE FROM kids WHERE subcategory_id = ?";
...
<div class="subcategories">
    <?php
    // Fetch and display existing subcategories from the kids table
    $fetchSubcategoriesQuery = "SELECT * FROM kids";
    ...
    while ($row = mysqli_fetch_assoc($subcategoriesResult)) {
        echo '<div class="subcategory-card">
                ...
                <a class="btn btn-primary" href="view_productskids.php?subcategory=' . $row['subcategory'] . '">View</a>
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="productSubcategory" name="productSubcategory" required>
                            <?php
                            // Display subcategories from the kids table
                            $fetchSubcategoriesQuery = "SELECT * FROM kids";
                            $subcategoriesResult = mysqli_query($conn, $fetchSubcategoriesQuery);
