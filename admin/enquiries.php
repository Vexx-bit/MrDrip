...
$resultEnquiries = mysqli_query($conn, $sqlEnquiries);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <nav class="navbar" id="sticky-navbar">
        <div class="container-fluid">
            ...
            <span class="navbar-brand">Enquiries </span>
    ...
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            <tbody>
            <?php
                while ($rowEnquiry = mysqli_fetch_assoc($resultEnquiries)) {
                    $enquiryName = $rowEnquiry['enq_name'];
                    $enquiryEmail = $rowEnquiry['enq_email'];
                    $enquiryMessage = $rowEnquiry['enq_message'];
                    $enquiryDate = $rowEnquiry['enq_date']; // Change 'enq_date' to the actual field name
                    
                    echo "<tr>";
                    echo "<td class='enquiry-name'>$enquiryName</td>";
                    echo "<td>$enquiryEmail</td>";
                    echo "<td class='enquiry-message'>$enquiryMessage</td>";
