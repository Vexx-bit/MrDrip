...
<body>
    ...
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            <tbody>
                <tr>
                    <td class="feedback-user">John Doe</td>
                    <td class="feedback-message">Great products and fast delivery!</td>
                    <td>2023-08-17</td>
                </tr>
                <tr>
                    <td class="feedback-user">Jane Smith</td>
                    <td class="feedback-message">Excellent customer service, highly recommended!</td>
                    <td>2023-08-16</td>
                </tr>
            </tbody>
        </table>
