...
<nav class="navbar" id="sticky-navbar">
    ...
    <div class="container mt-5">
        <a href="women.php" class="btn btn-secondary mb-3">Back to Subcategories</a>
        ...
        if (isset($_GET['delete_product'])) {
            ...
            if ($stmt) {
                ...
                if (mysqli_stmt_affected_rows($stmt) > 0) {
                    echo "<script>window.open('view_productsmen.php?subcategory=" . urlencode($_GET['subcategory']) . "', '_self');</script>";
                    exit();
                }
        ...
        if (isset($_GET['subcategory'])) {
            ...
            $query = "SELECT * FROM products WHERE product_category = 'Women' AND product_subcategory = '$subcategory'";
            ...
            if (isset($_POST['update'])) {
                ...
                if ($result) {
                    if (mysqli_affected_rows($conn) > 0) {
                        echo "<script>window.open('view_productswomen.php?subcategory=" . urlencode($_GET['subcategory']) . "', '_self');</script>";
                        exit();
                    } else {
