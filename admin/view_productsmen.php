...
<nav class="navbar" id="sticky-navbar">
    ...
    <div class="container mt-5">
        <a href="men.php" class="btn btn-secondary mb-3">Back to Subcategories</a>
        ...
        if (isset($_GET['subcategory'])) {
            ...
            $query = "SELECT * FROM products WHERE product_category = 'Men' AND product_subcategory = '$subcategory'";
