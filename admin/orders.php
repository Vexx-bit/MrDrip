        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <ul>
                            <li>Product 1 (Size: M, Quantity: 2)</li>
                            <li>Product 2 (Size: L, Quantity: 1)</li>
                        </ul>
                    </td>
                    <td class="order-total">$150.00</td>
                </tr>
                <tr>
                    <td class="order-id">67890</td>
                    <td>2023-08-16</td>
                    <td>
                        <ul>
                            <li>Product 3 (Size: S, Quantity: 3)</li>
                            <li>Product 4 (Size: XL, Quantity: 2)</li>
                        </ul>
                    </td>
                    <td class="order-total">$250.00</td>
                </tr>
            </tbody>
        </table>
    </div>
