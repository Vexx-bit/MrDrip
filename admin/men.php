...
if(isset($_POST['addSubcategory'])) {
    ...
    $insertSubcategoryQuery = "INSERT INTO men (subcategory) VALUES ('$subcategoryName')";
    if(mysqli_query($conn, $insertSubcategoryQuery)) {
        // Success: Redirect to men.php (or refresh the page)
        echo"<script>window.open('men.php','_self')</script>";
        exit();
    } else {
...
if(isset($_GET['deleteCategory'])) {
    ...
    // Delete the category from the men table
    $deleteCategoryQuery = "DELETE FROM men WHERE subcategory_id = ?";
...
<div class="subcategories">
    <?php
    // Fetch and display existing subcategories from the men table
    $fetchSubcategoriesQuery = "SELECT * FROM men";
    ...
    while ($row = mysqli_fetch_assoc($subcategoriesResult)) {
        echo '<div class="subcategory-card">
                ...
                <a class="btn btn-primary" href="view_productsmen.php?subcategory=' . $row['subcategory'] . '">View</a>
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="productSubcategory" name="productSubcategory" required>
                            <?php
                            // Display subcategories from the men table
                            $fetchSubcategoriesQuery = "SELECT * FROM men";
                            $subcategoriesResult = mysqli_query($conn, $fetchSubcategoriesQuery);
