...
$sqlCustomers = "SELECT * FROM users";
...
<body>
    ...
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            <tbody>
            <?php
                while ($rowCustomer = mysqli_fetch_assoc($resultCustomers)) {
                    echo "<tr>";
                    echo "<td class='customer-name'>" . $rowCustomer['fullname'] . "</td>";
                    echo "<td class='customer-email'>" . $rowCustomer['email'] . "</td>";
                    echo "</tr>";
                }
                ?>
            </tbody>
